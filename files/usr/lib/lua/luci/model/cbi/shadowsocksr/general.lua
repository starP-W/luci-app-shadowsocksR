...
ssmethod = s:option(ListValue, "ssmethod", translate("Encryption Method"))
ssmethod:depends("tool","Shadowsocks")
ssmethod:value("chacha20-ietf-poly1305")
ssmethod:value("aes-256-gcm")
ssmethod:value("aes-192-gcm")
ssmethod:value("aes-128-gcm")
ssmethod:value("aes-128-ctr")
ssmethod:value("aes-192-ctr")
ssmethod:value("aes-256-ctr")
ssmethod:value("aes-128-cfb")
ssmethod:value("aes-192-cfb")
ssmethod:value("aes-256-cfb")
ssmethod:value("camellia-128-cfb")
ssmethod:value("camellia-192-cfb")
ssmethod:value("camellia-256-cfb")
ssmethod:value("chacha20-ietf")
ssmethod:value("table")
ssmethod:value("none")
